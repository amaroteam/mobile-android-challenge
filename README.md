...
## A few guidelines
* The app must read product data from the [products resource](http://www.mocky.io/v2/59b6a65a0f0000e90471257d) API.
* All products available from the resource must be displayed.
* To initiate the test, just fork this repository, and once done, please use the words *FINISH!* in your last commit.
...
* Don't forget to follwow Google's [material design](https://getmdl.io/components/index.html) guidelines.
